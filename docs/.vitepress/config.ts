        ...
        sidebar: [
            {
                ...
                items: [
                    ...
                    { link: "div", text: "div" },
                    { link: "exp", text: "exp" },
                    { link: "finiteOr", text: "finiteOr" },
                    { link: "finiteOrElse", text: "finiteOrElse" },
                    { link: "finiteOrThrow", text: "finiteOrThrow" },
                    { link: "floatOr", text: "floatOr" },
                    { link: "floatOrElse", text: "floatOrElse" },
                    { link: "floatOrThrow", text: "floatOrThrow" },
                    { link: "floor", text: "floor" },
                    { link: "gt", text: "gt" },
                    { link: "gte", text: "gte" },
                    { link: "intOr", text: "intOr" },
                    { link: "intOrElse", text: "intOrElse" },
                    { link: "intOrThrow", text: "intOrThrow" },
                    { link: "is", text: "is" },
